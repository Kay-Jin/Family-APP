...
-- ---------------------------------------------------------------------------
-- Care suite: quick status, voice mailbox, medical cards, birthdays, presence
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Push tokens (FCM / APNs; filled by app after firebase_messaging is wired)
-- ---------------------------------------------------------------------------
...
grant select, insert, delete on public.family_status_posts to authenticated;
grant select, insert, update, delete on public.family_voice_messages to authenticated;
grant select, insert, update, delete on public.family_medical_cards to authenticated;
grant select, insert, update, delete on public.family_birthday_reminders to authenticated;
grant select, insert, update, delete on public.family_care_preferences to authenticated;
grant select, insert, update, delete on public.family_care_presence to authenticated;
